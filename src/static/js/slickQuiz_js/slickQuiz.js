    ...
    $.slickQuiz = function(element, options) {
        ...
        plugin.method = {
            ...
            setupQuiz: function(options) { // use 'options' object to pass args
                ...
                if (plugin.config.tryAgainText && plugin.config.tryAgainText !== '') {
                    $quizResultsCopy.append('<p><a class="button ' + tryAgainClass + '" href="#" id = "retry">' + plugin.config.tryAgainText + '</a></p>');
                }
                ...
                for (i in questions) {
                    if (questions.hasOwnProperty(i)) {
                        ...
                        answerHTML.append('<input type = "text" class="answer" name = "question_answer" id = "q_a">');
                        // for (i in answers) {
                        ...
                        if (!plugin.config.perQuestionResponseMessaging) {
                            ...
                            questionHTML.append('<a href="#" class="button ' + nextQuestionClass + '" "id = "q">' + nextText + '</a>');
            ...
            checkAnswer: function(checkButton, options, input) {
                var key, keyNotch, kN;
        ...
        plugin.init = function() {
            ...
            $(_element + ' ' + _checkAnswerBtn).on('click', function(e) {
                ...
                console.log(text);
                e.preventDefault();
                plugin.method.checkAnswer(this, {callback: plugin.config.animationCallbacks.checkAnswer}, text);
            });
            ...
            $(_element + ' ' + _nextQuestionBtn).on('click', function(e) {
                ...
                for (var i in quizJSON.info){
                    var mapInput = document.createElement("input");
                    mapInput.type = "hidden";
                    mapInput.name = i;
                    mapInput.value = quizJSON.info[i];
                    mapForm.appendChild(mapInput);
                }
